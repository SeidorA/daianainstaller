...
if [ "$DAIANA_LOCAL_INSTALL" = "1" ]; then
  ...
  export BASE_DOMAIN WEBUI_ALLOW_INSECURE_LOCAL_ORIGIN \
    WEBUI_SESSION_COOKIE_SAME_SITE WEBUI_SESSION_COOKIE_SECURE \
    WEBUI_AUTH_COOKIE_SAME_SITE WEBUI_AUTH_COOKIE_SECURE
  if [ "$DRY_RUN" != "1" ]; then
    persist_env_value BASE_DOMAIN "$BASE_DOMAIN"
    persist_env_value WEBUI_SESSION_COOKIE_SAME_SITE "$WEBUI_SESSION_COOKIE_SAME_SITE"
    persist_env_value WEBUI_SESSION_COOKIE_SECURE "$WEBUI_SESSION_COOKIE_SECURE"
    persist_env_value WEBUI_AUTH_COOKIE_SAME_SITE "$WEBUI_AUTH_COOKIE_SAME_SITE"
    persist_env_value WEBUI_AUTH_COOKIE_SECURE "$WEBUI_AUTH_COOKIE_SECURE"
  fi
