...
- Normal source-ref validation uses each repository's fixed local baseline:
  ...
  `cd910e8a22c43947cf5f726ec7e8ef85da157e57` and Python
...
DAIANA_DEPLOYMENT_MODE=local-candidate DAIANA_HARNESS_NO_PUSH=1 \
 ...
 DAIANA_CANDIDATE_NEXT_IMAGE=cloudseidoranalytics/daiana:sha-cd910e8a22c43947cf5f726ec7e8ef85da157e57 \
