...
This is a local-only, self-contained PostgreSQL package for the six approved legacy-safe Daiana compatibility operations. It never uses Docker, Compose, an Installer checkout, or either Installer migration ledger.
