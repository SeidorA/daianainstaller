-- Forward-only corrective migration. CREATE OR REPLACE preserves explicit
-- grants, and Supabase API-role default privileges can grant new overloads to
-- anon and authenticated unless each role is revoked directly.
