...
The installer checks these first and, when possible, offers to install missing `docker` (Linux), `curl`, `jq`, `openssl`, `psql`, `supabase`, and Compose packages automatically.
