...
approved_next='cloudseidoranalytics/daiana:sha-892c3e34c07b8d2c6b1c49736a90ba192bb6c3f8'
...
expect_reject "${approved_env[@]}" "${local_guard[@]}" DAIANA_CANDIDATE_NEXT_IMAGE='cloudseidoranalytics/daiananext:sha-892c3e34c07b8d2c6b1c49736a90ba192bb6c3f8'
expect_reject "${approved_env[@]}" "${local_guard[@]}" DAIANA_CANDIDATE_PYTHON_IMAGE='cloudseidoranalytics/daianapython:sha-892c3e34c07b8d2c6b1c49736a90ba192bb6c3f8'
expect_reject "${approved_env[@]}" "${local_guard[@]}" DAIANA_APPROVED_PYTHON_SOURCE_SHA=892c3e34c07b8d2c6b1c49736a90ba192bb6c3f8
expect_reject "${approved_env[@]}" "${local_guard[@]}" DAIANA_APPROVED_STUDIO_SOURCE_SHA=892c3e34c07b8d2c6b1c49736a90ba192bb6c3f8
expect_reject "${approved_env[@]}" "${local_guard[@]}" DAIANA_CANDIDATE_NEXT_IMAGE='attacker/daiana:sha-892c3e34c07b8d2c6b1c49736a90ba192bb6c3f8'
